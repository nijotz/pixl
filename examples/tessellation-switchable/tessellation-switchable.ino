...
LEDStrip strip2 = LEDStrip(256);
LEDStrip strip3 = LEDStrip(198);
LEDStrip strip4 = LEDStrip(150);
LEDStrip strip5 = LEDStrip(216);

// Curtain LEDs
LEDs leds1 = LEDs(&strip1, 0, 150);
LEDs leds2 = LEDs(&strip2, 0, 256);
LEDs leds3 = LEDs(&strip3, 0, 198);
LEDs leds4 = LEDs(&strip4, 0, 150);
LEDs leds5 = LEDs(&strip5, 0, 216);
...
void setup() {
  ...
  FastLED.addLeds<WS2811,  5, RGB>(strip2.leds, 256); // Left four 8x8 squares
  FastLED.addLeds<WS2811, 21, BRG>(strip3.leds, 198); // Left eleven 6x6x6 triangles
  //FastLED.addLeds<WS2811, 20, RGB>(strip4.leds, 150); // Right four 8x8 squares (not functional
  FastLED.addLeds<WS2811,  6, BRG>(strip5.leds, 216); // Right twelve 6x6x6 triangles
