...
int circle_length = 30; //NumLEDS in circle mic
...
// Circle
LEDs circle_led = LEDs(&strip6, 0, circle_length);
...
void setup() {
  ...
  FastLED.addLeds<WS2811, 21, RGB>(strip3.leds, 150); // Middle Cymatic Curtain
  FastLED.addLeds<WS2811,  7, RGB>(strip4.leds, 150);
  FastLED.addLeds<WS2811,  6, RGB>(strip5.leds, 288); // Pixelbox
  FastLED.addLeds<WS2811, 20, GRB>(strip6.leds, 150); // LED Mic
