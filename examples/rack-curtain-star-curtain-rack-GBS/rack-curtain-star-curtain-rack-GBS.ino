...
void setup() {
  ...
  FastLED.addLeds<WS2811, 20, RGB>(strip11.leds, 150); // Far Right Curtain
  FastLED.addLeds<WS2811, 7, RGB>(strip12.leds, 150); // Inner Right Curtain
  FastLED.addLeds<WS2811, 14, RGB>(strip13.leds, 150); // Inner Left Curtain
  FastLED.addLeds<WS2811, 6, RGB>(strip14.leds, 150); // Far Left Curtain
  FastLED.addLeds<WS2811, 2, GRB>(strip.leds, STRIP); // Cymatic Star
  FastLED.addLeds<WS2811, 21, GRB>(strip10.leds, 150); // LED Mic
